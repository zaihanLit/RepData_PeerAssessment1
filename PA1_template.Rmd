...
```
The mean of total number of steps taken per day: `r meanstep`

The median of total number of steps taken per day: `r medianstep`
...
In the plot, we can find that the 5-minute interval `r maxinterval` contains the maximum number of average steps across all the days.

The average step in that 5-minute interval is `r maxstep` steps.
...
```
The total number of missing values in the dataset is `r numofNA`. It can explain why the number of days in [0,5000] range is so big in the histogram plot.
